...
const page = () => {
  return (
    <div className='bg-neutral-950 text-white h-[1400px]'>
      ...
      <form className='flex flex-col max-w-[600px] pt-14 px-10 space-y-[12px] font-work text-[1.1rem]'>
        ...
        <input placeholder='MM/DD/YYYY' className='bg-transparent border-2 border-white outline-none rounded-md py-1 pl-2' />
